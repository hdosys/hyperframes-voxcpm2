...
```powershell
pwsh -NoProfile -File scripts/build-release.ps1 -Version 0.1.3
pwsh -NoProfile -File scripts/test-release.ps1 -Archive dist/hyperframes-voxcpm2-v0.1.3-windows-x64.zip
```
