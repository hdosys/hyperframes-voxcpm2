...
```powershell
pwsh -NoProfile -File scripts/build-release.ps1 -Version 0.1.5
pwsh -NoProfile -File scripts/test-release.ps1 -Archive dist/hyperframes-voxcpm2-v0.1.5-windows-x64.zip
```
